1. Keep your existing 20+ row employee_salary_dataset_ml_300.csv.
...
10. Enter Employee ID, Name, Email and professional values. Predict sends data to n8n, Gemini generates the recommendation, Gmail sends it, n8n returns it, and Python saves it to the same CSV.
