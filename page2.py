...
# Heading1
heading1 = tk.Label(root, text="EMPLOYEE SALARY PREDICTION AND ANALYSIS SYSTEM",
                   font=("Arial", 14, "bold"))
heading1.grid(row=0, column=8, columnspan=2, pady=10)

# Heading2
heading2 = tk.Label(root, text="Employee Information",
                   font=("Arial", 12, "bold"))
heading2.grid(row=1, column=3, columnspan=2, pady=10)

# First Name
tk.Label(root, text="Employee ID",font=("Arial", 12)).grid(row=2, column=3, padx=10, pady=5, sticky="w")
...
heading3 = tk.Label(root, text="Professional Information",
                   font=("Arial", 12, "bold"))
heading3.grid(row=1, column=15, columnspan=2, pady=10)

# First Name
tk.Label(root, text="Experience",font=("Arial", 12)).grid(row=2, column=14, padx=10, pady=5, sticky="w")
entry_first = tk.Entry(root, width=30)
entry_first.grid(row=2, column=15, padx=10, pady=5)

# Last Name
tk.Label(root, text="Education Level",font=("Arial", 12)).grid(row=3, column=14, padx=10, pady=5, sticky="w")
entry_last = tk.Entry(root, width=30)
entry_last.grid(row=3, column=15, padx=10, pady=5)
# First Name
tk.Label(root, text="Performance Rating",font=("Arial", 12)).grid(row=4, column=14, padx=10, pady=5, sticky="w")
entry_first = tk.Entry(root, width=30)
entry_first.grid(row=4, column=15, padx=10, pady=5)

# Last Name
tk.Label(root, text="Skill Score",font=("Arial", 12)).grid(row=5, column=14, padx=10, pady=5, sticky="w")
entry_last = tk.Entry(root, width=30)
entry_last.grid(row=5, column=15, padx=10, pady=5)
# First Name
tk.Label(root, text="Previous Salary Percentile",font=("Arial", 12)).grid(row=6, column=14, padx=10, pady=5, sticky="w")
entry_first = tk.Entry(root, width=30)
entry_first.grid(row=6, column=15, padx=10, pady=5)

# Button
submit_btn = tk.Button(root, text="Predict Salary", command=submit,bg="blue",fg="white")
...
output_label = tk.Label(root, text="Retention Risk:", font=("Arial", 12), fg="black", justify="left")
